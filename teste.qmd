...
## História Digital existe? {.center}
...
## Como é que se começa um projeto em história? {.center}
...
- Curso de Licenciatura em História (IHL-UNILAB): historia.ba@unilab.edu.br
- Laboratório de Humanidades Digitais da UFBA: [labhdufba.com.br](https://labdufba.com.br)
- Mestrado Interdisciplinar em Humanidades Digitais - PPGIHD/UFRRJ
